...
Contributions to the Kii library are welcome. As a contributor, here are the guidelines we would like you to follow:
...
For bug reports, it is important that we can reproduce and confirm it. For this, we need you to provide minimal reproduction instructions (this is part of the bug report issue template).
...
The Kii team reserves the right not to accept pull requests from community members who haven't been good citizens of the community. Such behavior includes not following our [Code of Conduct][coc] and applies within or outside the managed channels.
...
- Keep API compatibility in mind when you change any code under `Kii`. Above version `1.0.0`, breaking changes can happen across versions with different left digits. Below version `1.0.0`, they can happen across versions with different middle digits. Reviewers of your pull request will comment on any API compatibility issues.
