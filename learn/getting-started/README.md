...
KiiChain is the onchain FX layer that connects global stablecoin liquidity with local-currency markets. This section covers wallets, bridging KII, and where to start on mainnet or testnet.

### Networks

* **Mainnet** — production network for Kiichain (`kiichain_1783-1`). Details: [Kiichain Mainnet](../../build-on-kiichain/kiichain-mainnet.md)
* **Testnet Oro** — permanent public testnet for builds, hackathons, and testing. Join activities at [kiichain.io/testnet](https://kiichain.io/testnet)

### Bridge KII

Move KII between Kiichain and supported chains (BSC, Polygon, Base, Ethereum, Mantle) with Hyperlane. Addresses and Nexus instructions:
...
The Explorer App can be automatically connected to MetaMask or Keplr via the RPC endpoints. Once you have installed the MetaMask extension, follow the steps [here](connect-wallet-to-explorer-app.md) to connect your wallet and begin delegating.

### Developer resources

If you’re a developer and are interested in building with KiiChain, a good place to start is reviewing the introduction information [here](../../build-on-kiichain/developer-hub.md).

Quick start links:

* [Launch a node/full node/validator](../../validate-the-network/run-a-validator-full-node/getting-started.md)
